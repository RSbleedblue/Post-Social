...
function RSideFeed() {
  return (
    <div className="rounded-lg text-black h-[285px] flex-1 flex flex-col pl-6 justify-between relative">
      ...
      <div className="bg-white w-[95%] rounded-xl h-[140px] pl-28 text-xl">
        Luffy
      </div>
      <div className="bg-white w-28 rounded-full h-28 md:w-[140px] md:h-[140px] absolute -translate-y-1/2 top-1/2 -left-4 border-bgmain border-8 overflow-hidden">
        <img src={luffy} alt="" />
      </div>
    </div>
  );
